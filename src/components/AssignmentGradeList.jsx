...
const AssignmentGradeList = ({columns, data, isTeacher, assignmentIds, assignmentIsFinals, setFinal}) => {
    const {
                        ...
                        >
                            ...
                            {isAssignmentColumn(column.id) && (
                                <>
                                    ...
                                    {!Boolean(isTeacher) && (
                                        <p>     {Boolean(assignmentIsFinals[column.id.split(`[`)[1].split(`]`)[0]]) ? "Đã có điểm" : "Chưa có điểm"}</p>
                                    )}
                                </>
                            )}
                        </td>
